...
public class SegurancaDelegateRN implements SegurancaDelegateIf{
	...
	public Collection findFuncionalidadeByPerfis(Collection<PerfilVO> collPerfil) throws AmbienteException, AplicacaoException{
		System.out.println("funcionalidadeRN " + funcionalidadeRN);
	...
	public void setUsuarioRN(UsuarioRN usuarioRN) {
		System.out.println("usuarioRN " + usuarioRN);
		this.usuarioRN = usuarioRN;
		System.out.println("this.usuarioRN " + this.usuarioRN);
	}
	...
	public void setFuncionalidadeRN(FuncionalidadeRN funcionalidadeRN) {
		System.out.println("funcionalidadeRN " + funcionalidadeRN);
		this.funcionalidadeRN = funcionalidadeRN;
		System.out.println("this.funcionalidadeRN " + this.funcionalidadeRN);
	}
