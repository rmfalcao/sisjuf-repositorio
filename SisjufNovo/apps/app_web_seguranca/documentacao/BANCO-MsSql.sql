CREATE TABLE FUNCIONALIDADE (
  SEQ_FUNCIONALIDADE INTEGER IDENTITY NOT NULL,
...
CREATE TABLE LINK_FUNCAO (
  SEQ_LINK INTEGER IDENTITY NOT NULL,
...
CREATE TABLE FUNCAO (
  SEQ_FUNCAO INTEGER IDENTITY NOT NULL,
...
CREATE TABLE PERFIL (
  SEQ_PERFIL INTEGER IDENTITY NOT NULL,
  NOME VARCHAR(50) NULL UNIQUE,
  DESCRICAO VARCHAR(100) NULL,
...
CREATE TABLE USUARIO (
  SEQ_USUARIO INTEGER IDENTITY NOT NULL,
