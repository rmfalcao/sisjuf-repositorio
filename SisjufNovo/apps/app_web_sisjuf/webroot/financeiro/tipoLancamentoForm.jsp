		...
		<body>
			...
			<div id="geral">
				<div id="topo">
					...
					<div id="voltar">
						voltar <a href="<c:url value="/financeiro/tipoLancamentoConsulta.jsf"/>"><img src="<c:url value="/nucleo/images/setinhavoltar.gif"/>" /></a>
					</div>
				</div>
		
				<%@ include file="/nucleo/includes/inc_menuFinanceiro.jsp" %>
				<h:form id="TipoLancamentoForm">
					<div id="miolo">
						<h1>Módulo Financeiro</h1>
						<h2>Tipos de Lançamentos - Cadastro</h2>
						<t:messages id="msgs" showDetail="true" showSummary="false" errorClass="textoMsgErro" infoClass="textoMsgInfo"/>
						<table class="tab_cadastro" cellpadding="2" cellspacing="1">
							<thead>
								<tr>
									<th width="190">Tipo do Lançamento</th>
									<th width="400"></th>
								</tr>
							</thead>
							<tbody>
								<tr>
									...
									<td>
										<t:inputText id="nome" value="#{TipoLancamentoBean.tipoLancamento.nome}" size="30" maxlength="30" required="true"/>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<br />
						<t:commandLink action="#{TipoLancamentoBean.salvar}" title="#{properties['lb_salvar']}" id="salvar" styleClass="botao_salvar"
						onclick="setAcao(document.forms[0], 'Salva_TipoLancamento');">
						<h:outputText value="#{properties['lb_salvar']}" />
						</t:commandLink>
						<input type="hidden" name="acao" value=""/>
						<h:inputHidden id="codigo" value="#{TipoLancamentoBean.tipoLancamento.codigo}"/>
					</div>
				</h:form>
			</div>
		</body>
