	...
	<html>
		...
		<div id="topo_impressao">
			...
			<span>
				...
				Operador: <t:outputText value="#{AtividadeConvenioBean.operador}" />
				<br />
				Data de impressão: <t:outputText value="#{AtividadeConvenioBean.dataAtual}" />
			</span>
		</div>
		<h:form id="atividadeResultado">
			<t:dataTable id="data" var="atividades" value="#{AtividadeConvenioBean.atividades}" cellspacing="1" cellpadding="3" width="100%" preserveDataModel="false"
			...
			<t:column width="68">
				...
				<h:outputText value="#{properties['lb_desativo']}" rendered="#{atividades.flagDesativado}" />
				<h:outputText value="#{properties['lb_ativo']}" rendered="#{!atividades.flagDesativado}" />
			</t:column>
