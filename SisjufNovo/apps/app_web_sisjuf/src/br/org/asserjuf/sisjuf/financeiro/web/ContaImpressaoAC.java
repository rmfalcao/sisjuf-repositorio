...
/**
 * Servlet da tela de impressão de contas.
 * @author Paulo Prado
 */
public class ContaImpressaoAC extends FrameworkServlet {
	...
	protected void doService(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		request.getRequestDispatcher("/financeiro/contaPrint.jsp").forward(request, response);
	}
