...
public class FaturaDAO extends SisjufDAOPostgres {
	...
	public Collection<ItemFaturaInconsistenteVO> findItensInconsistentesByFatura(FaturaVO fatura) throws SmartEnvException {
		...
		sql.append(" SELECT 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, B.NOM_TITULAR, IF.VAL_ITEM_FATURA, 'NÃƒO ENCONTRADO NO ARQUIVO DO CONVÊNIO' AS TIPO_INCONSISTENCIA ")
			...
			.append(" UNION ALL ")
			.append(" SELECT 	FA.SEQ_FATURA_ARQUIVO, IFA.CODIGO_BENEFICIARIO_PLANO, IFA.NOM_BENEFICIARIO, '(nao identificado)' as NOM_TITULAR, IFA.VAL_ITEM_FATURA_ARQUIVO, 'NÃƒO ENCONTRADO NO CADASTRO ASSERJUF' AS TIPO_INCONSISTENCIA ")
			...
			.append(" UNION ALL ")
			.append(" SELECT 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, B.NOM_TITULAR, IF.VAL_ITEM_FATURA, 'VALOR NÃO BATE' AS TIPO_INCONSISTENCIA ")
