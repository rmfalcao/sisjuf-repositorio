...
public class FaturaDAO extends SisjufDAOPostgres {
	...
	public Collection<ItemFaturaInconsistenteVO> findItensInconsistentesByFatura(FaturaVO fatura) throws SmartEnvException {
		...
		sql.append(" SELECT 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, B.NOM_TITULAR, IF.VAL_ITEM_FATURA, null as VAL_ITEM_FATURA_ARQUIVO, 'NAƒO ENCONTRADO NO ARQUIVO DO CONVÊNIO' AS TIPO_INCONSISTENCIA ")
			...
			.append(" UNION ALL ")
			.append(" SELECT 	FA.SEQ_FATURA_ARQUIVO, IFA.CODIGO_BENEFICIARIO_PLANO, IFA.NOM_BENEFICIARIO, '(nao identificado)' as NOM_TITULAR, null as VAL_ITEM_FATURA, IFA.VAL_ITEM_FATURA_ARQUIVO, 'NAƒO ENCONTRADO NO CADASTRO ASSERJUF' AS TIPO_INCONSISTENCIA ")
			...
			.append(" UNION ALL ")
			.append(" SELECT 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, B.NOM_TITULAR, IF.VAL_ITEM_FATURA, IFA.VAL_ITEM_FATURA_ARQUIVO, 'VALOR NAO BATE' AS TIPO_INCONSISTENCIA ")
			...
			.append(" AND 	F.SEQ_FATURA = ? ")
			.append(" UNION ALL ")
			.append(" SELECT F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO,  B.NOM_PESSOA AS NOM_BENEFICIARIO, A.NOM_PESSOA AS NOM_TITULAR, IF.VAL_ITEM_FATURA, NULL AS VAL_ITEM_FATURA_ARQUIVO, 'MATRICULA DO CONVENIO DUPLICADA NO SISJUF'  AS TIPO_INCONSISTENCIA ")
			.append(" FROM VINCULACAO_PLANO VP, ")
			.append(" PESSOA B, PESSOA A, PLANO_CONVENIO PC, FATURA F, ITEM_FATURA IF ")
			.append(" WHERE EXISTS (SELECT 1 FROM VINCULACAO_PLANO VP2 ")
			.append(" WHERE VP2.SEQ_VINCULACAO <> VP.SEQ_VINCULACAO ")
			.append(" AND VP2.SEQ_PESSOA <> VP.SEQ_PESSOA ")
			.append(" AND VP2.CODIGO_BENEFICIARIO_PLANO = VP.CODIGO_BENEFICIARIO_PLANO ")
			.append(" AND VP2.SEQ_PLANO = PC.SEQ_PLANO ")
			.append(" AND VP2.DAT_DESVINCULACAO IS NULL ")
			.append(" ) AND VP.SEQ_PLANO = PC.SEQ_PLANO ")
			.append(" AND PC.SEQ_CONVENIO = F.SEQ_CONVENIO ")
			.append(" AND F.SEQ_FATURA = ? ")
			.append(" AND F.SEQ_FATURA = IF.SEQ_FATURA ")
			.append(" AND IF.SEQ_VINCULACAO = VP.SEQ_VINCULACAO ")
			.append(" AND VP.DAT_DESVINCULACAO IS NULL ")
			.append(" AND VP.SEQ_PESSOA = B.SEQ_PESSOA ")
		...
		try {
			...
			sStmt.setParameters(fatura, new String[] {"codigo","codigo","codigo", "codigo", "codigo", "codigo"});
	...
	public FaturaArquivoVO salvarRelatorioInconsistencias(FaturaArquivoVO faturaArquivo) throws SmartEnvException {
		...
		sql.append(" INSERT INTO RELATORIO_INCONSISTENCIAS (SEQ_RELATORIO_INCONSISTENCIAS, DAT_RELATORIO_INCONSISTENCIAS, SEQ_FATURA, CODIGO_BENEFICIARIO_PLANO, NOM_BENEFICIARIO, NOM_TITULAR, VAL_ITEM_FATURA, VAL_ITEM_FATURA_ARQUIVO, TIPO_INCONSISTENCIA) ")
			.append(" SELECT 	?, CURRENT_TIMESTAMP, F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, B.NOM_TITULAR, IF.VAL_ITEM_FATURA, null as VAL_ITEM_FATURA_ARQUIVO, 'NAO ENCONTRADO NO ARQUIVO DO CONVENIO' AS TIPO_INCONSISTENCIA ")
			.append(" FROM 	FATURA F, ITEM_FATURA IF, VINCULACAO_PLANO VP, VW_BENEFICIARIO B ")
			.append(" WHERE 	F.SEQ_FATURA = IF.SEQ_FATURA ")
			.append(" AND	IF.SEQ_VINCULACAO = VP.SEQ_VINCULACAO ")
			.append(" AND	VP.SEQ_PESSOA = B.SEQ_BENEFICIARIO ")
			...
			.append(" AND 	F.SEQ_FATURA = ? ")
			.append(" UNION ALL ")
			.append(" SELECT 	?, CURRENT_TIMESTAMP, FA.SEQ_FATURA_ARQUIVO, IFA.CODIGO_BENEFICIARIO_PLANO, IFA.NOM_BENEFICIARIO, '(nao identificado)' as NOM_TITULAR, null as VAL_ITEM_FATURA, IFA.VAL_ITEM_FATURA_ARQUIVO, 'NAƒO ENCONTRADO NO CADASTRO ASSERJUF' AS TIPO_INCONSISTENCIA ")
			.append(" FROM	FATURA_ARQUIVO FA, ITEM_FATURA_ARQUIVO IFA ")
			.append(" WHERE 	FA.SEQ_FATURA_ARQUIVO = IFA.SEQ_FATURA_ARQUIVO ")
			.append(" AND	IFA.CODIGO_BENEFICIARIO_PLANO NOT IN ( ")
			.append(" SELECT 	VP.CODIGO_BENEFICIARIO_PLANO ")
			...
			.append(" AND FA.SEQ_FATURA_ARQUIVO = ? ")
			.append(" UNION ALL ")
			.append(" SELECT ?, CURRENT_TIMESTAMP, 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, B.NOM_TITULAR, IF.VAL_ITEM_FATURA, IFA.VAL_ITEM_FATURA_ARQUIVO, 'VALOR NAO BATE' AS TIPO_INCONSISTENCIA ")
			.append(" FROM	FATURA F, ITEM_FATURA IF, VINCULACAO_PLANO VP, VW_BENEFICIARIO B, ITEM_FATURA_ARQUIVO IFA ")
			.append(" WHERE 	F.SEQ_FATURA = IF.SEQ_FATURA ")
			.append(" AND	IF.SEQ_VINCULACAO = VP.SEQ_VINCULACAO ")
			.append(" AND	VP.SEQ_PESSOA = B.SEQ_BENEFICIARIO ")
			...
			.append(" AND 	F.SEQ_FATURA = ? ")
			.append(" UNION ALL ")
			.append(" SELECT ?, CURRENT_TIMESTAMP, 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO,  B.NOM_PESSOA AS NOM_BENEFICIARIO, A.NOM_PESSOA AS NOM_TITULAR, IF.VAL_ITEM_FATURA, NULL AS VAL_ITEM_FATURA_ARQUIVO, 'MATRICULA DO CONVENIO DUPLICADA NO SISJUF'  AS TIPO_INCONSISTENCIA ")
			.append(" FROM VINCULACAO_PLANO VP, ")
			.append(" PESSOA B, PESSOA A, PLANO_CONVENIO PC, FATURA F, ITEM_FATURA IF ")
			.append(" WHERE EXISTS (SELECT 1 FROM VINCULACAO_PLANO VP2 ")
			.append(" WHERE VP2.SEQ_VINCULACAO <> VP.SEQ_VINCULACAO ")
		...
		try {
			...
			sStmt.setParameters(faturaArquivo, new String[]{"codigoRelatorioInconsistencias", "codigo", "codigo", "codigoRelatorioInconsistencias", "codigo", "codigo", "codigoRelatorioInconsistencias", "codigo","codigoRelatorioInconsistencias", "codigo"});
