...
public class FaturaDAO extends SisjufDAOPostgres {
	...
	public Collection<ItemFaturaInconsistenteVO> findItensInconsistentesByFatura(FaturaVO fatura) throws SmartEnvException {
		...
		sql.append(" SELECT 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, IF.VAL_ITEM_FATURA, 'NÃO ENCONTRADO NO ARQUIVO' AS TIPO_INCONSISTENCIA ")
			...
			.append(" UNION ALL ")
			.append(" SELECT 	FA.SEQ_FATURA_ARQUIVO, IFA.CODIGO_BENEFICIARIO_PLANO, IFA.NOM_BENEFICIARIO, IFA.VAL_ITEM_FATURA_ARQUIVO, 'NÃO ENCONTRADO NO CADASTRO SISJUF' AS TIPO_INCONSISTENCIA ")
			...
			.append(" UNION ALL ")
			.append(" SELECT 	F.SEQ_FATURA, VP.CODIGO_BENEFICIARIO_PLANO, B.NOM_BENEFICIARIO, IF.VAL_ITEM_FATURA, 'VALOR N�O BATE' AS TIPO_INCONSISTENCIA ")
