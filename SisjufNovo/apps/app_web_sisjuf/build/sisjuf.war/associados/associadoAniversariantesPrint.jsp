	...
	<html>
		...
		<body>
			...
			<div id="topo_impressao">
				...
				<span>
					<h1>Lista de Associados de Aniversariantes</h1>
			...
			<h:form id="associadoResultado">
				<t:dataTable id="data" var="associados" value="#{AssociadoBean.associadosAniversariantes}" cellspacing="1" cellpadding="2" width="100%" styleClass="tabela_impressao" 
