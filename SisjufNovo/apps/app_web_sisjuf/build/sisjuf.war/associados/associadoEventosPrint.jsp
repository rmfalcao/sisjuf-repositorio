	...
	<html>
		...
		<body>
			...
			<div id="topo_impressao">
				...
				<span>
					<h1>Lista de Eventos do Associados</h1>
			...
			<h:form id="associadoResultado">
				<t:dataTable id="data" var="historico" value="#{AssociadoBean.historicoAssociado}" cellspacing="1" cellpadding="2" width="100%" styleClass="tabela_impressao" 
